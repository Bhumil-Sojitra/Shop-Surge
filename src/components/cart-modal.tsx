...
export default function CartModel() {
  ...
  return (
    <div className="w-max absolute flex flex-col gap-6 p-4 rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] top-12 right-0 text-sm bg-white z-20">
      {!cartItems ? (
        <div className="text-lg text-semibold">
          Cart is <span className="text-fixedColor">empty</span>
        </div>
      ) : (
        <>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col justify-between w-full">
                ...
                <div className="flex items-center justify-between gap-8">
                  ...
                  <div className="p-1 bg-fixedColor text-white rounded-sm">
                    $50
                  </div>
                </div>
                {/* DESC */}
                <div className="text-sm rounded-sm bg-emerald-400 w-fit p-1">
                  available
                </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-between">
              <button className="rounded p-2 bg-white ring-1 ring-black text-black">
                View Cart
              </button>
